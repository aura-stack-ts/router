...
describe("Client type inference with Zod schemas", () => {
    test("With params", async () => {
        ...
        const getBooksConfig = createEndpointConfig({
            schemas: {
                params: valibot.object({ bookId: valibot.string(), chapterId: valibot.string() }),
            },
        })
        ...
        const deleteItemConfig = createEndpointConfig({
            schemas: {
                params: valibot.object({ itemId: valibot.string() }),
                searchParams: valibot.object({ force: valibot.optional(valibot.string()) }),
            },
        })
        ...
        const callbackConfig = createEndpointConfig({
            schemas: {
                searchParams: valibot.object({
                    ...
                    code_challenge: valibot.optional(valibot.string()),
                }),
            },
        })
        ...
        const createUserConfig = createEndpointConfig({
            schemas: {
                body: valibot.object({
                    ...
                    is_eval: valibot.boolean(),
                    cash: valibot.number(),
                    items: valibot.array(valibot.string()),
                }),
            },
        })
    ...
    test("With response", async () => {
        ...
        const multiStatusCodeConfig = createEndpointConfig({
            schemas: {
                response: {
                    ...
                    404: valibot.object({ error: valibot.string(), code: valibot.string(), id: valibot.number() }),
                },
            },
        })
        ...
        const multiStatusCodeConfigWithDefault = createEndpointConfig({
            schemas: {
                response: {
                    ...
                    302: valibot.object({ location: valibot.string() }),
                    404: valibot.object({ code: valibot.string(), id: valibot.number(), error: valibot.string() }),
                    500: valibot.object({ code: valibot.string(), id: valibot.number(), error: valibot.string() }),
                },
            },
        })
        ...
        const withParamsConfig = createEndpointConfig({
            schemas: {
                response: {
                    200: valibot.object({
                        param1: valibot.string(),
                        param2: valibot.string(),
                    }),
                    4040: valibot.object({
