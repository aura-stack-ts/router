...
<Callout>
  ...
  [Schema Validation](/docs/guides/validation).
</Callout>
...
<Callout>
  ...
  against the (possibly transformed) value it produced. See [Schema Validation](/docs/guides/validation).
</Callout>
...
<Callout>
  ...
  runs. See [Schema Validation](/docs/guides/validation).
</Callout>
...
<Callout>
  If `schemas.response` is defined, invalid headers reject the request with `422 Unprocessable Entity` after this hook runs. See
  [Schema Validation](/docs/guides/validation).
</Callout>
