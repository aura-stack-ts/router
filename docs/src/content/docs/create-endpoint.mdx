...
```ts lineNumbers
import type { RoutePattern, EndpointConfig, RouteHandler } from "@aura-stack/router/types"

type Handler<Route extends RoutePattern, Config extends EndpointConfig> = RouteHandler<Route, Config>
```
