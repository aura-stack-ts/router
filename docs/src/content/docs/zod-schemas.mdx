...
```ts lineNumbers
import { Object, Number } from "typebox"
import { createEndpoint } from "@aura-stack/router"
...
export const config = createEndpointConfig("/users/:userId/books/:bookId", {
  schemas: {
    params: Object({
      userId: String({ format: "regex", pattern: "^[0-9]+$" }),
...
```ts lineNumbers
import { Object, String, Integer, Transform } from "typebox"
import { createEndpointConfig, createEndpoint } from "@aura-stack/router"
...
```ts lineNumbers
import { Object, String, Boolean, Array, Literal, Union } from "typebox"
import { createEndpointConfig, createEndpoint } from "@aura-stack/router"
  ...
  schemas: {
    body: Object({
      profile: Object({
        ...
        bio: Optional(String({ maxLength: 500 })),
      }),
      settings: Object({
        theme: Union([Literal("light"), Literal("dark")], { default: "light" }),
        notifications: Boolean({ default: true }),
        language: String({ minLength: 2, maxLength: 2, default: "en" }),
      }),
